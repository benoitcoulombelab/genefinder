...
public class ApplicationPresenter {
    ...
    private void initialize() {
        ...
        ManageOrganismsPresenter manageOrganismsPresenter = (ManageOrganismsPresenter) manageOrganismsView
                .getPresenter();
        geneFinderPresenter.organismsProperty().bindBidirectional(manageOrganismsPresenter.organismsProperty());
