 ...
 * 
 * Written by: (the stack overflow users, obviously!) Headerified, refactored
 * and commented by Code Bling http://stackoverflow.com/users/675721/code-bling
 * Network file support added by Stefan Cordes
 * http://stackoverflow.com/users/81330/stefan-cordes Adapted by Sam Brightman
 * http://stackoverflow.com/users/2492/sam-brightman Based on information in
 ...
 */
@edu.umd.cs.findbugs.annotations.SuppressWarnings(value = "DM_DEFAULT_ENCODING", justification = "Code copied from stackoverflow")
